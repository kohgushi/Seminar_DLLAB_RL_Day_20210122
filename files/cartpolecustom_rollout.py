...
if __name__ == "__main__":
    ...
    rollout_parser.add_argument('--model_name', required=False,
        help='Name of the registered model if any')
    rollout_parser.add_argument(
    ...
    if(args.model_name):
        ...
        checkpoint_file = os.path.join(artifacts_path, checkpoint_file)
